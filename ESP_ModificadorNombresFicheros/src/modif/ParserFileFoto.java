...
public class ParserFileFoto {
	...
	private String tipo;
	// Número, es una cadena de 4 dígitos
	private String numero;
	// Resto del nombre
	private String resto;
	// Extensión: JPG, AVI o THM
	...
	public ParserFileFoto(String nombre) {
		if (nombre.matches("[0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]_[A-Z][A-Z][A-Z]*.*"))  {
			...
			// Es un nombre de archivo original de la cámara, con formato nuevo
			this.tipo = nombre.substring(0, 3).toUpperCase();
			/* Antes era así, antes de la conversión de todas las fotos
				// Los archivos con estos numeros, iban desde el '1'6296 hasta el '2'1908
				// con lo cual, su quinto dígito puede ser '1' ó '2'
			...
			*/
			...
			// Es un nombre de archivo completamente nuevo, NO de los originales de la cámara
			...
			// Es un nombre de archivo que no sigue ninguna convención
			this.modificado = false;
			this.tipo = "";
			this.numero = "";
			this.resto = "";
