...
public class MainPruebas {
	public static void main(String[] args) {
		...
		System.out.println("e elevado a " + z + " da por una lado " + FuncionesComplejas.exponencial(z)
				+ ". Por otro lado da "
				+ FuncionesComplejas.elevadoA(FuncionesComplejas.toNumeroComplejo(Math.exp(1)), z));
		...
		System.out.println("El número " + z + " tiene de inverso " + FuncionesComplejas.inverso(z)
				+ " y por otro lado da " + FuncionesComplejas.elevadoA(z, FuncionesComplejas.const_neg1));
		System.out.println("El inverso del inverso es: " + FuncionesComplejas
				.elevadoA(FuncionesComplejas.inverso(z), FuncionesComplejas.const_neg1));
		System.out.println("En esta caso, la parte real es " + FuncionesComplejas
				.elevadoA(FuncionesComplejas.inverso(z), FuncionesComplejas.const_neg1)
				.getRe());
	...
	private static NumeroComplejo funcionComplejaEjemplo(NumeroComplejo z) {
		...
		ret = FuncionesComplejas.suma(ret, FuncionesComplejas
				.multiplicacion(FuncionesComplejas.const_neg1,
						FuncionesComplejas
								.exponencial(FuncionesComplejas
										.multiplicacion(
