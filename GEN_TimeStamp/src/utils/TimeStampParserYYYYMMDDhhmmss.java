...
public class TimeStampParserYYYYMMDDhhmmss extends TimeStampParser {
	...
	protected TimeStampParserYYYYMMDDhhmmss(String s) {
		super(s);
	}
	...
	protected boolean esStringConforme() {
		/*
		 * Formato posible: aaaammddhhmmss (14 caracteres) (Definido en
		 * CADENA_COMP)
		 * 
		 * en vez de cifras, puede usarse el caracter 'x' para indicar un dato
		 * indefinido. Por ejemplo "197803xx12xxxx" indicará algún día del mes
